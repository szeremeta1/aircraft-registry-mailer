...
import { Aircraft } from './types'; // Import the Aircraft type from the shared types file
...
export const insertAircraft = async (aircraft: Aircraft) => {
    const query = `
    ...
    const values = [
        ...
        aircraft.ownerName,
        aircraft.street, // using 'street' instead of 'address'
        aircraft.city,
        aircraft.state,
        aircraft.zipCode,
